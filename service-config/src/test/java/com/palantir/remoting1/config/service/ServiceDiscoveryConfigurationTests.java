...
public final class ServiceDiscoveryConfigurationTests {
    ...
    public void serDe() throws Exception {
        ...
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedCamelCase, ServiceDiscoveryConfiguration.class))
                .isEqualTo(serialized);
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedKebabCase, ServiceDiscoveryConfiguration.class))
                .isEqualTo(serialized);
    }
