...
public final class ProxyConfigurationTests {
    ...
    public void serDe() throws Exception {
        ...
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedCamelCase, ProxyConfiguration.class))
                .isEqualTo(serialized);
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedKebabCase, ProxyConfiguration.class))
                .isEqualTo(serialized);
    }
