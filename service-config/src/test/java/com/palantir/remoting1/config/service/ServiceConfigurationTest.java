...
public final class ServiceConfigurationTest {
    ...
    public void serDe() throws Exception {
        ...
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedCamelCase, ServiceConfiguration.class))
                .isEqualTo(serialized);
        assertThat(ObjectMappers.guavaJdk8().readValue(deserializedKebabCase, ServiceConfiguration.class))
                .isEqualTo(serialized);
    }
