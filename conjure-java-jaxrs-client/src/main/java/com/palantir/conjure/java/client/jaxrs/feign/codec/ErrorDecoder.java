 ...
 */
package com.palantir.conjure.java.client.jaxrs.feign.codec;

import static com.palantir.conjure.java.client.jaxrs.feign.FeignException.errorStatus;
import static com.palantir.conjure.java.client.jaxrs.feign.Util.RETRY_AFTER;
...
import com.palantir.conjure.java.client.jaxrs.feign.RetryableException;
 ...
 * {@link RetryableException retryable}).
 *
