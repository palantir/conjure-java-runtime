...
/**
 * Expands OptionalDouble by using null for {@link OptionalDouble#empty()} and the {@link Double#toString()} of the
 * value otherwise.
 */
final class Java8NullOptionalDoubleExpander implements Expander {
