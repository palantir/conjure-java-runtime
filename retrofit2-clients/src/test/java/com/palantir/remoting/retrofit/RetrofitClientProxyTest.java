...
public final class RetrofitClientProxyTest {
    ...
    public void testDirectVersusProxyConnection() throws Exception {
        ...
        TestService directService = RetrofitClientFactory.createProxy(
        ...
        TestService proxiedService = RetrofitClientFactory.createProxy(
                Optional.<SSLSocketFactory>absent(),
                "http://localhost:" + server.getPort(),
                TestService.class,
                OkHttpClientOptions.builder().build(),
    ...
    public void testAuthenticatedProxy() throws Exception {
        ...
        ProxyConfiguration proxyConfiguration = ProxyConfiguration.of(
