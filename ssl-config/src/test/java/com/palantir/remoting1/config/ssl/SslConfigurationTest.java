...
public final class SslConfigurationTest {
    ...
    public void testSerDe() throws Exception {
        ...
        assertThat(ObjectMappers.guavaJdk7().readValue(deserializedCamelCase, SslConfiguration.class))
                .isEqualTo(serialized);
        assertThat(ObjectMappers.guavaJdk7().readValue(deserializedKebabCase, SslConfiguration.class))
                .isEqualTo(serialized);
    }
