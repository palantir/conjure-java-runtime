...
@JsonDeserialize(as = ImmutableSslConfigurationCopy.class)
@JsonSerialize(as = ImmutableSslConfigurationCopy.class)
@Value.Immutable
@Value.Style(visibility = ImplementationVisibility.PACKAGE)
public abstract class SslConfigurationCopy {
    ...
    public static SslConfigurationCopy of(Path trustStorePath) {
        return SslConfigurationCopy.builder().trustStorePath(trustStorePath).build();
    }

    public static SslConfigurationCopy of(Path trustStorePath, Path keyStorePath, String keyStorePassword) {
        return SslConfigurationCopy.builder()
    ...
    public static class Builder extends ImmutableSslConfigurationCopy.Builder {}
