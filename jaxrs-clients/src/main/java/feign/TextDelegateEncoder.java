...
import com.palantir.remoting1.jaxrs.feignimpl.HeaderAccessUtils;
...
/**
 * Delegates to a {@link Encoder.Default} if the response has a Content-Type of text/plain, or falls back to the given
 * delegate otherwise.
 */
