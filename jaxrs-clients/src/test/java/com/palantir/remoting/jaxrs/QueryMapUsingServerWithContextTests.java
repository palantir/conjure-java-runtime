...
public final class QueryMapUsingServerWithContextTests {
    ...
    /**
     * Creates a {@link com.palantir.remoting.jaxrs.QueryMapTestServer.WithContext} Dropwizard server.
    ...
    public static final DropwizardAppRule<Configuration> APP = new DropwizardAppRule<>(
            com.palantir.remoting.jaxrs.QueryMapTestServer.WithContext.class,
