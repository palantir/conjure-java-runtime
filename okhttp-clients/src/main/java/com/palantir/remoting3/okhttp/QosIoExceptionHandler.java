...
interface QosIoExceptionHandler {
     ...
     * <ul>
     *     <li>
     *         OkHttp remoting doesn't have out-of-the-box support for re-locating complex reqests,
     ...
     * </ul>
     */
    CompletableFuture<Response> handle(QosIoExceptionAwareCall call, QosIoException exception);
}
