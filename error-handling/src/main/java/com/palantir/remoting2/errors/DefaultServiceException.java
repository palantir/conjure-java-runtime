...
public class DefaultServiceException extends ServiceException {
    ...
    public DefaultServiceException(Throwable cause, String messageFormat, Param<?>... messageArgs) {
        this(DEFAULT_STATUS, cause, messageFormat,  messageArgs);
    }

    public DefaultServiceException(int status, String messageFormat, Param<?>... messageArgs) {
        this(status, null, messageFormat,  messageArgs);
    }

    public DefaultServiceException(int status, @Nullable Throwable cause, String messageFormat,
            Param<?>... messageArgs) {
