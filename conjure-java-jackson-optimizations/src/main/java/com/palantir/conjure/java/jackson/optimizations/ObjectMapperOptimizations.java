...
public final class ObjectMapperOptimizations {
    ...
    private static final boolean NO_OPTIMIZATIONS =
            // Blackbird generates accessor classes via LambdaMetafactory at runtime, which is incompatible with
            // graalvm native-image. The nativeimage check should not be refactored into a utility method which may
            // reduce our ability to tree-shake.
            System.getProperty("org.graalvm.nativeimage.imagecode") != null
                    || Boolean.getBoolean("com.palantir.conjure.java.jackson.optimizations.disabled");

    public static List<? extends com.fasterxml.jackson.databind.Module> createModules() {
        return NO_OPTIMIZATIONS ? List.of() : List.of(new BlackbirdModule());
    }
